Here is a comprehensive, structured project brief designed specifically for your Agentic IDE (like Cursor, Windsurf, or GitHub Copilot Workspace).

This brief explains the **strategic rationale**, the **course-to-code mapping**, and the **exact blueprint** of the system. You can paste this directly into your IDE's prompt or context file, and your agent will instantly understand why every single decision was made.
